...
public class SpinnerVendorAdapter extends BaseAdapter implements android.widget.SpinnerAdapter {
    ArrayList<VendorsDetail> getUserList;
    Context context;

    public SpinnerVendorAdapter(ArrayList<VendorsDetail> getUserList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        text.setText(getUserList.get(position).getVendorno());
        return text;
    }
}