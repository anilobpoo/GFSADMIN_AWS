...
public class DeleteCompClient extends BaseHttpClient {

    public HttpReqResCallBack callBack;


    public DeleteCompClient(Context context) {
        super.context = context;
    }

    public void getJsonForType(Map<String, String> mapOfRequestParams) {
        HttpClient.context = context;
        HttpClient.post(UrlBuilder.formatRequestURLByRequestType(Constants.DELETE_COMP, mapOfRequestParams), mapOfRequestParams, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                if (responseBody != null) {
                    callBack.jsonResponseReceived(new String(responseBody), statusCode, Constants.DELETE_COMP);
                } else {
                    callBack.jsonResponseReceived(null, statusCode, Constants.DELETE_COMP);
                }
            }
        ...
        }, Constants.CONTENT_TYPE_JSON, Constants.DELETE_COMP);
    }
}
