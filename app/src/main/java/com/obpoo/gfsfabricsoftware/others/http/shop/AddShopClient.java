...
public class AddShopClient extends BaseHttpClient {

    public HttpReqResCallBack callBack;


    public AddShopClient(Context context) {
        super.context = context;
    }

    public void getJsonForType(Map<String, String> mapOfRequestParams) {
        HttpClient.context = context;
        HttpClient.post(UrlBuilder.formatRequestURLByRequestType(Constants.ADD_SHOP, mapOfRequestParams), mapOfRequestParams, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                if (responseBody != null) {
                    callBack.jsonResponseReceived(new String(responseBody), statusCode, Constants.ADD_SHOP);
                } else {
                    callBack.jsonResponseReceived(null, statusCode, Constants.ADD_SHOP);
                }
            }
        ...
        }, Constants.CONTENT_TYPE_JSON, Constants.ADD_SHOP);
    }
}
