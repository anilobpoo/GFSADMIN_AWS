...
public class SpinnerColorAdapter extends BaseAdapter implements android.widget.SpinnerAdapter{
    ArrayList<ColorDetail> getUserList;
    Context context;

    public SpinnerColorAdapter(ArrayList<ColorDetail> getUserList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        text.setText(getUserList.get(position).getColor_code());
        return text;
    }
}
