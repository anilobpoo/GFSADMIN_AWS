...
public class MoveFabrics extends BaseActivity implements BundleView,ShelfBarcodeView,StockInView,IMethodCallers {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movefabrics);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("Move Fabrics");
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                stockin.setEnabled(true);
                stockout.setEnabled(false);
                startActivityForResult(new Intent(MoveFabrics.this,Scanning.class),BUNDLE);
            }
        });
        scan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult(new Intent(MoveFabrics.this,Scanning.class),SHELFID);
            }
        });
        ...
        stockin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // hs.addAll(bundleArray);
                ...
                //stockInPresenter.add(shelfid,"remove_packets",bundleArray,userid,userid);

                stockInPresenter.move(userid,"remove_packets",bundleArray);
            }
        });
...
//                recyclerView.getAdapter().notifyDataSetChanged();
                  ...
                  startActivity(new Intent(getApplicationContext(),StockActivityMain.class));
               }
