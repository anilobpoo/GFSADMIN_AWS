...
public class UpdateWarehouse extends BaseActivity implements WarehouseView,ShopView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Edit Warehouse");
        ...
        submit.setText("Update Warehouse");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                presenter.edit("update_warehouse",fullname,no,can,city,add,av,shopId,id);
    ...
    public void onLoad(WarehouseResponse response) {
        ...
        if (response.getStatus().equals(AppConstants.SUCCESS)) {
            ...
            {
                warehouseDetails=response.getDetail();
                for (int i = 0; i < warehouseDetails.size(); i++) {
                    String name=warehouseDetails.get(i).getWarehouse_name();
                    String number=warehouseDetails.get(i).getWarehouse_no();
                    can=warehouseDetails.get(i).getCan_sell_part();
                    shopId=warehouseDetails.get(i).getShopNo();
                    String loc=warehouseDetails.get(i).getLocality();
                    String ad=warehouseDetails.get(i).getAddress();
                    String Available_status=warehouseDetails.get(i).getAvailable_status();
                    String shopname=warehouseDetails.get(i).getShopname();
                    ...
                    if (can.equals("0"))
                    {
                        allow.setText("Allow to sell part of roll");
                    }else
                        allow.setText("Not Allow to sell part of roll");
                    availbile.setText(Available_status);
