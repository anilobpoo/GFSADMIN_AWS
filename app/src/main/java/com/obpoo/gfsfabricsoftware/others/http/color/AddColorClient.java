...
public class AddColorClient extends BaseHttpClient {

    public HttpReqResCallBack callBack;

    public AddColorClient(Context context) {
        super.context = context;
    }

    public void getJsonForType(Map<String, String> mapOfRequestParams) {
        HttpClient.context = context;
        HttpClient.post(UrlBuilder.formatRequestURLByRequestType(Constants.ADD_COLOR, mapOfRequestParams), mapOfRequestParams, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                if (responseBody != null) {
                    callBack.jsonResponseReceived(new String(responseBody), statusCode, Constants.ADD_COLOR);
                } else {
                    callBack.jsonResponseReceived(null, statusCode, Constants.ADD_COLOR);
                }
            }
        ...
        }, Constants.CONTENT_TYPE_JSON, Constants.ADD_COLOR);
    }
}
