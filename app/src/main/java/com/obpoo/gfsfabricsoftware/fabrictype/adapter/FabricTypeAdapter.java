package com.obpoo.gfsfabricsoftware.fabrictype.adapter;
...
public class FabricTypeAdapter extends RecyclerView.Adapter<FabricTypeAdapter.MyViewHolder> implements FabricTypeView{
    private Context context;
    private ArrayList<FabricTypeDetail> cartList;
    Activity activity;
    ...
    public void updateList(ArrayList<FabricTypeDetail> list){
        cartList = list;
    ...
    public FabricTypeAdapter(Activity context, ArrayList<FabricTypeDetail> cartList) {
    ...
    @Override
    public FabricTypeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_master, parent, false);

        return new FabricTypeAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final FabricTypeAdapter.MyViewHolder holder, final int position) {
        final FabricTypeDetail item = cartList.get(position);


        String name = item.getFabric_type();
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (tag.equals("0"))
                {
                    ...
                    holder.name.setText("");
                    holder.name.append(item.getFabric_type());
        ...
        alertDialogBuilder
                ...
                .setPositiveButton(activity.getResources().getString(R.string.Yes),new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        presenter.delete("delete",String.valueOf(ids),"del","delete");
