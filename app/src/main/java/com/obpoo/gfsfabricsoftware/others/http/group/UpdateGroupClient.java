...
public class UpdateGroupClient extends BaseHttpClient {

    public HttpReqResCallBack callBack;


    public UpdateGroupClient(Context context) {
        super.context = context;
    }

    public void getJsonForType(Map<String, String> mapOfRequestParams) {
        HttpClient.context = context;
        HttpClient.post(UrlBuilder.formatRequestURLByRequestType(Constants.EDIT_GROUP, mapOfRequestParams), mapOfRequestParams, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                if (responseBody != null) {
                    callBack.jsonResponseReceived(new String(responseBody), statusCode, Constants.EDIT_GROUP);
                } else {
                    callBack.jsonResponseReceived(null, statusCode, Constants.EDIT_GROUP);
                }
            }
        ...
        }, Constants.CONTENT_TYPE_JSON, Constants.EDIT_GROUP);
    }
}
