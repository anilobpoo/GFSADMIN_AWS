...
public class UpdateCompClient extends BaseHttpClient {

    public HttpReqResCallBack callBack;


    public UpdateCompClient(Context context) {
        super.context = context;
    }

    public void getJsonForType(Map<String, String> mapOfRequestParams) {
        HttpClient.context = context;
        HttpClient.post(UrlBuilder.formatRequestURLByRequestType(Constants.EDIT_COMP, mapOfRequestParams), mapOfRequestParams, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                if (responseBody != null) {
                    callBack.jsonResponseReceived(new String(responseBody), statusCode, Constants.EDIT_COMP);
                } else {
                    callBack.jsonResponseReceived(null, statusCode, Constants.EDIT_COMP);
                }
            }
        ...
        }, Constants.CONTENT_TYPE_JSON, Constants.EDIT_COMP);
    }
}
