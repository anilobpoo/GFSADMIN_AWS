...
public class TrackPODetItems implements Parcelable {
    @SerializedName("id")
    @Expose
    private String id;
    @SerializedName("oid")
    ...
    protected TrackPODetItems(Parcel in) {
        id = in.readString();
        oid = in.readString();
        customerId = in.readString();
        shipingId = in.readString();
        fabId = in.readString();
    ...
    public static final Creator<TrackPODetItems> CREATOR = new Creator<TrackPODetItems>() {
        @Override
        public TrackPODetItems createFromParcel(Parcel in) {
            return new TrackPODetItems(in);
        }

        @Override
        public TrackPODetItems[] newArray(int size) {
            return new TrackPODetItems[size];
        }
    };
