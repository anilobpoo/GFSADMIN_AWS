...
public class DeleteBankClient extends BaseHttpClient {

    public HttpReqResCallBack callBack;


    public DeleteBankClient(Context context) {
        super.context = context;
    }

    public void getJsonForType(Map<String, String> mapOfRequestParams) {
        HttpClient.context = context;
        HttpClient.post(UrlBuilder.formatRequestURLByRequestType(Constants.DELETE_BANK, mapOfRequestParams), mapOfRequestParams, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                if (responseBody != null) {
                    callBack.jsonResponseReceived(new String(responseBody), statusCode, Constants.DELETE_BANK);
                } else {
                    callBack.jsonResponseReceived(null, statusCode, Constants.DELETE_BANK);
                }
            }
        ...
        }, Constants.CONTENT_TYPE_JSON, Constants.DELETE_BANK);
    }
}
