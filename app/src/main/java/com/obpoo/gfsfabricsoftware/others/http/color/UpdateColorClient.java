...
public class UpdateColorClient extends BaseHttpClient {

    public HttpReqResCallBack callBack;


    public UpdateColorClient(Context context) {
        super.context = context;
    }

    public void getJsonForType(Map<String, String> mapOfRequestParams) {
        HttpClient.context = context;
        HttpClient.post(UrlBuilder.formatRequestURLByRequestType(Constants.EDIT_COLOR, mapOfRequestParams), mapOfRequestParams, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                if (responseBody != null) {
                    callBack.jsonResponseReceived(new String(responseBody), statusCode, Constants.EDIT_COLOR);
                } else {
                    callBack.jsonResponseReceived(null, statusCode, Constants.EDIT_COLOR);
                }
            }
        ...
        }, Constants.CONTENT_TYPE_JSON, Constants.EDIT_COLOR);
    }
}
