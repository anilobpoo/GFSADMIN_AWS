...
public class TrackPObyCusData implements Parcelable {
    ...
    protected TrackPObyCusData(Parcel in) {
        ...
        otp = in.readString();
        shippingMark = in.readString();
        deleteStatus = in.readString();
    }

    public static final Creator<TrackPObyCusData> CREATOR = new Creator<TrackPObyCusData>() {
        @Override
        public TrackPObyCusData createFromParcel(Parcel in) {
            return new TrackPObyCusData(in);
        }

        @Override
        public TrackPObyCusData[] newArray(int size) {
            return new TrackPObyCusData[size];
        }
    };
